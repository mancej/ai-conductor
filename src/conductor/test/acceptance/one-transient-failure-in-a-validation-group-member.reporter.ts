...
const INTENT_RATIONALE =
  'The failing state assertion proves the no-verdict join still discards siblings whose dispatch and objective gate verdicts passed.';

export default class ValidationGroupSiblingRetentionRedReporter implements Reporter {
