...
const INTENT_RATIONALE =
  'The failure proves the production startup path cannot yet select a discovered visualizer connector and deliver run events through the registered seam.';

export default class ConnectorSeamAcceptanceRedReporter implements Reporter {
